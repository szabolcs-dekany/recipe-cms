package io.hypesync.flamny.scrapper.config;
...
@Configuration
@EnableMongoRepositories("io.hypesync.flamny.scrapper.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.hypesync.flamny.scrapper.config.dbmigrations");
